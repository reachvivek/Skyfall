...
function ProductSection() {
  ...
  }, "Once you have deployed Skyfall, \"You\" have complete ownership and command of your data. We never come into your picture. Our prime focus is on your daily use-case where you place your sensitive credentials and other confidential data with 3rd Party Applications which can be reverse looked up and always has a possible risk of data leak / contingency associated with the existing use-case. We ensure that those credentials are securely stored without the intervention of any third-party applications and this prevents any possible future contingency like data leaks from occurring in the first place and shields the user all in all by giving them their own key-base."))), __jsx("div", {
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 36,
...
//# sourceMappingURL=home.js.2d69602a51a9e3ee1bd3.hot-update.js.map