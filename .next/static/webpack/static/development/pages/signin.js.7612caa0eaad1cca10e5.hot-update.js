...
/* harmony import */ var amazon_cognito_identity_js__WEBPACK_IMPORTED_MODULE_31__ = __webpack_require__(/*! amazon-cognito-identity-js */ "./node_modules/amazon-cognito-identity-js/es/index.js");
...
function LoginPage(props) {
  ...
  var onSubmit = function onSubmit(event) {
    event.preventDefault();
    var user = new amazon_cognito_identity_js__WEBPACK_IMPORTED_MODULE_31__["CognitoUser"]({
      Username: email,
      Pool: _userpool__WEBPACK_IMPORTED_MODULE_23__["default"]
    });
    var authDetails = new amazon_cognito_identity_js__WEBPACK_IMPORTED_MODULE_31__["AuthenticationDetails"]({
      Username: email,
      Password: password
    });
    user.authenticateUser(authDetails, {
      onSuccess: function onSuccess(data) {
        ...
        next_Router__WEBPACK_IMPORTED_MODULE_30___default.a.push("/dashboard.js");
      },
  ...
  }, "SIGN IN"))))))), __jsx(components_Footer_Footer_js__WEBPACK_IMPORTED_MODULE_11__["default"], {
    whiteFont: true,
    __self: this,
    __source: {
      fileName: _jsxFileName,
...
//# sourceMappingURL=signin.js.7612caa0eaad1cca10e5.hot-update.js.map