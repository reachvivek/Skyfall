...
function LoginPage(props) {
  ...
  var onSubmit = function onSubmit(event) {
    ...
    _userpool__WEBPACK_IMPORTED_MODULE_23__["default"].signUp(email, password, [], null, function (err, data) {
      if (err) {
        console.error(err);
        next_router__WEBPACK_IMPORTED_MODULE_30___default.a.push("/error");
      } else {
        next_router__WEBPACK_IMPORTED_MODULE_30___default.a.push("/check-email");
      }
    });
  };
...
//# sourceMappingURL=signup.js.00ba56b6ca7abb984b46.hot-update.js.map